...
st.title('Interactive web page for Machine Learning for stakeholders.')
image = Image.open('MachineLearning.jpg')
...
#DELING WITH THE ABOUT US PAGE
		...
		st.markdown('This is an interactive web page for a ML project. This dataset is fetched from the UCI Machine learning repository. The analysis in here is to demonstrate how we can present our work to our stakeholders in an interractive way by building a web app for our machine learning algorithms using different dataset.'
			)
